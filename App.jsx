...
function App({
  ...
  useEffect(() => {
    ...
    /** @type {Array} */
    const completeDataList = [...dataToAdd, ...bubbleData].filter(
      ({ _id }) => !dataToDelete.includes(_id)
    );
  ...
  console.log("SLECTED DATA", selectedData);
